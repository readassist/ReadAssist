    ...
    if (word != null && key === 'getSynonym' && clickedStop===false) {
        ...
        .then(response => {
          ...
          response.json().then(function(data) {
            ...
            for (let ps=0; ps<meaning.length; ps++) {
              ...
              var slen = data[0].meanings[ps].definitions[0].synonyms.length % 3;
            ...
            //Send synonym
            chrome.runtime.sendMessage({greeting: 'pushSynonym', word: word, data: synonym}, function(response) {
      ...
      .then(response => {
          ...
          response.json().then(function(data) {
            ...
            //Send synonym
            chrome.runtime.sendMessage({greeting: 'pushSynonym', word: word, data: ssynonym}, function(response) {
              //Sent message to background.js
            }); 
          });
      })
