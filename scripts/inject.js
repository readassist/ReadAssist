...
// disableIframeModals = function() {
//   //Close modal in all iframes if open
//   iframes = document.getElementsByTagName("iframe");
//   for (var j=0; j<iframes.length; j++) {
//     iframes[j].contentWindow.document.getElementById("readAssistModal").style.display = "none";
//   }
// }
// window.onload = disableIframeModals;
...
function handleModalDisplay(synonym, word) {
  var modalText = document.getElementById("readAssistTextHere");
  modalText.innerHTML = '<br><strong>Word: </strong>'+word+'<br><br>'+'<strong>Synonym: </strong><br>'+synonym;
  // Get the modal
